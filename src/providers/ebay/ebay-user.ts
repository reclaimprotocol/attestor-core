...
// what API to call
const METHOD = 'GET'
const URL = '/mye/myebay/summary'

const ebayUser: Provider<EbayUserParams, EbayUserSecretParams> = {
	hostPort: HOSTPORT,
	areValidParams(params): params is EbayUserParams {
	...
	assertValidProviderReceipt(receipt, { userName }) {
		...
		const reqMatch = `<span class=m-top-nav__right><a href=https://www.ebay.com/usr/${userName}`
