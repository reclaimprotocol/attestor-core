...
import { AttestationReport } from "./tee-bundle.ts";
...
export interface ClaimTeeBundleResponse_Signatures {
  ...
  /**
   * Attestation from the TEE the attestor is running in,
   * binding the attestor's signing key to the enclave.
   * Empty when the attestor is not running in a TEE.
   */
  claimAttestation: AttestationReport | undefined;
}
...
export const ClaimTeeBundleResponse_Signatures: MessageFns<ClaimTeeBundleResponse_Signatures> = {
  encode(message: ClaimTeeBundleResponse_Signatures, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.claimAttestation !== undefined) {
      AttestationReport.encode(message.claimAttestation, writer.uint32(34).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.claimAttestation = AttestationReport.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ClaimTeeBundleResponse_Signatures {
    return {
      ...
      claimAttestation: isSet(object.claimAttestation)
        ? AttestationReport.fromJSON(object.claimAttestation)
        : undefined,
    };
  },
  ...
  toJSON(message: ClaimTeeBundleResponse_Signatures): unknown {
    ...
    if (message.claimAttestation !== undefined) {
      obj.claimAttestation = AttestationReport.toJSON(message.claimAttestation);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ClaimTeeBundleResponse_Signatures>): ClaimTeeBundleResponse_Signatures {
    ...
    message.claimAttestation = (object.claimAttestation !== undefined && object.claimAttestation !== null)
      ? AttestationReport.fromPartial(object.claimAttestation)
      : undefined;
    return message;
  },
};
