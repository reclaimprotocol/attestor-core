...
export interface HttpProviderParameters {
  ...
  geoLocation?: string;
  /**
   * Specify a session identifier for using same proxy IP for multiple request. Can be an smallcase alphanumeric string of length 8-14 characters. (public or secret)
   */
