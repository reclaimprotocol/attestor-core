...
export const SignedRedactedDecryptionStream: MessageFns<SignedRedactedDecryptionStream> = {
  ...
  fromJSON(object: any): SignedRedactedDecryptionStream {
    return {
      redactedStream: isSet(object.redactedStream)
        ? bytesFromBase64(object.redactedStream)
        : isSet(object.redacted_stream)
        ? bytesFromBase64(object.redacted_stream)
        : new Uint8Array(0),
  ...
  fromJSON(object: any): CertificateInfo {
    return {
      ...
      dnsNames: globalThis.Array.isArray(object?.dnsNames)
        ...
        : globalThis.Array.isArray(object?.dns_names)
        ? object.dns_names.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const HandshakeSecrets: MessageFns<HandshakeSecrets> = {
  ...
  fromJSON(object: any): HandshakeSecrets {
    return {
      handshakeKey: isSet(object.handshakeKey)
        ? bytesFromBase64(object.handshakeKey)
        : isSet(object.handshake_key)
        ? bytesFromBase64(object.handshake_key)
        : new Uint8Array(0),
      handshakeIv: isSet(object.handshakeIv)
        ? bytesFromBase64(object.handshakeIv)
        : isSet(object.handshake_iv)
        ? bytesFromBase64(object.handshake_iv)
        : new Uint8Array(0),
      cipherSuite: isSet(object.cipherSuite)
        ? globalThis.Number(object.cipherSuite)
        : isSet(object.cipher_suite)
...
export const Opening: MessageFns<Opening> = {
  ...
  fromJSON(object: any): Opening {
    return {
      proofStream: isSet(object.proofStream)
        ? bytesFromBase64(object.proofStream)
        : isSet(object.proof_stream)
        ? bytesFromBase64(object.proof_stream)
        : new Uint8Array(0),
    };
  },
...
function createBaseOPRFOutput(): OPRFOutput {
  return { tlsStart: 0, tlsLength: 0, hashOutput: new Uint8Array(0) };
}

export const OPRFOutput: MessageFns<OPRFOutput> = {
  encode(message: OPRFOutput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): OPRFOutput {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): OPRFOutput {
    return {
      tlsStart: isSet(object.tlsStart)
        ? globalThis.Number(object.tlsStart)
        : isSet(object.tls_start)
        ? globalThis.Number(object.tls_start)
        : 0,
      tlsLength: isSet(object.tlsLength)
        ? globalThis.Number(object.tlsLength)
        : isSet(object.tls_length)
        ? globalThis.Number(object.tls_length)
        : 0,
      hashOutput: isSet(object.hashOutput)
        ? bytesFromBase64(object.hashOutput)
        : isSet(object.hash_output)
        ? bytesFromBase64(object.hash_output)
        : new Uint8Array(0),
    };
  },

  toJSON(message: OPRFOutput): unknown {
    const obj: any = {};
    if (message.tlsStart !== 0) {
  ...
  create(base?: DeepPartial<OPRFOutput>): OPRFOutput {
    return OPRFOutput.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<OPRFOutput>): OPRFOutput {
    const message = createBaseOPRFOutput();
...
export const KOutputPayload: MessageFns<KOutputPayload> = {
  ...
  fromJSON(object: any): KOutputPayload {
    return {
      redactedRequest: isSet(object.redactedRequest)
        ? bytesFromBase64(object.redactedRequest)
        : isSet(object.redacted_request)
        ? bytesFromBase64(object.redacted_request)
        : new Uint8Array(0),
      ...
      consolidatedResponseKeystream: isSet(object.consolidatedResponseKeystream)
        ...
        : isSet(object.consolidated_response_keystream)
        ? bytesFromBase64(object.consolidated_response_keystream)
        : new Uint8Array(0),
      certificateInfo: isSet(object.certificateInfo)
        ? CertificateInfo.fromJSON(object.certificateInfo)
        : isSet(object.certificate_info)
        ? CertificateInfo.fromJSON(object.certificate_info)
        : undefined,
      ...
      oprfOutputs: globalThis.Array.isArray(object?.oprfOutputs)
        ...
        : globalThis.Array.isArray(object?.oprf_outputs)
        ? object.oprf_outputs.map((e: any) => OPRFOutput.fromJSON(e))
        : [],
      attestationType: isSet(object.attestationType)
        ? globalThis.String(object.attestationType)
  ...
  fromJSON(object: any): TOutputPayload {
    return {
      consolidatedResponseCiphertext: isSet(object.consolidatedResponseCiphertext)
        ...
        : isSet(object.consolidated_response_ciphertext)
        ? bytesFromBase64(object.consolidated_response_ciphertext)
        : new Uint8Array(0),
      requestProofStreams: globalThis.Array.isArray(object?.requestProofStreams)
        ...
        : globalThis.Array.isArray(object?.request_proof_streams)
        ? object.request_proof_streams.map((e: any) => bytesFromBase64(e))
        : [],
      timestampMs: isSet(object.timestampMs)
        ? globalThis.Number(object.timestampMs)
        : isSet(object.timestamp_ms)
...
export const SignedMessage: MessageFns<SignedMessage> = {
  ...
  fromJSON(object: any): SignedMessage {
    return {
      bodyType: isSet(object.bodyType)
        ? bodyTypeFromJSON(object.bodyType)
        : isSet(object.body_type)
        ? bodyTypeFromJSON(object.body_type)
        : 0,
      body: isSet(object.body) ? bytesFromBase64(object.body) : new Uint8Array(0),
      ethAddress: isSet(object.ethAddress)
        ? bytesFromBase64(object.ethAddress)
        : isSet(object.eth_address)
        ? bytesFromBase64(object.eth_address)
        : new Uint8Array(0),
      ...
      attestationReport: isSet(object.attestationReport)
        ...
        ? AttestationReport.fromJSON(object.attestation_report)
        : undefined,
    };
  },
...
export const OPRFVerificationData: MessageFns<OPRFVerificationData> = {
  ...
  fromJSON(object: any): OPRFVerificationData {
    return {
      streamPos: isSet(object.streamPos)
        ? globalThis.Number(object.streamPos)
        : isSet(object.stream_pos)
        ? globalThis.Number(object.stream_pos)
        : 0,
      streamLength: isSet(object.streamLength)
        ? globalThis.Number(object.streamLength)
        : isSet(object.stream_length)
        ? globalThis.Number(object.stream_length)
        : 0,
      publicSignalsJson: isSet(object.publicSignalsJson)
        ? bytesFromBase64(object.publicSignalsJson)
        : isSet(object.public_signals_json)
...
export const VerificationBundle: MessageFns<VerificationBundle> = {
  ...
  fromJSON(object: any): VerificationBundle {
    return {
      teekSigned: isSet(object.teekSigned)
        ? SignedMessage.fromJSON(object.teekSigned)
        : isSet(object.teek_signed)
        ? SignedMessage.fromJSON(object.teek_signed)
        : undefined,
      teetSigned: isSet(object.teetSigned)
        ? SignedMessage.fromJSON(object.teetSigned)
        : isSet(object.teet_signed)
        ? SignedMessage.fromJSON(object.teet_signed)
        : undefined,
      oprfVerifications: globalThis.Array.isArray(object?.oprfVerifications)
        ...
        : globalThis.Array.isArray(object?.oprf_verifications)
        ? object.oprf_verifications.map((e: any) => OPRFVerificationData.fromJSON(e))
        : [],
    };
  },
