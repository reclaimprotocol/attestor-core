...
export const BeaconIdentifier = {
  encode(message: BeaconIdentifier, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BeaconIdentifier {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WitnessErrorData = {
  encode(message: WitnessErrorData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WitnessErrorData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TunnelDisconnectEvent = {
  encode(message: TunnelDisconnectEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.error !== undefined) {
      WitnessErrorData.encode(message.error, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const ClaimTunnelResponse = {
  encode(message: ClaimTunnelResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.error !== undefined) {
      WitnessErrorData.encode(message.error, writer.uint32(26).fork()).join();
    }
    if (message.signatures !== undefined) {
...
export const RPCMessage = {
  encode(message: RPCMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.connectionTerminationAlert !== undefined) {
      WitnessErrorData.encode(message.connectionTerminationAlert, writer.uint32(34).fork()).join();
    }
    if (message.requestError !== undefined) {
      WitnessErrorData.encode(message.requestError, writer.uint32(42).fork()).join();
    }
